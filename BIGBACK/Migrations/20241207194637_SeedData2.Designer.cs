...
namespace BIGBACK.Migrations
{
    ...
    [Migration("20241207194637_SeedData2")]
            ...
            modelBuilder.Entity("BIGBACK.Domain.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CustomerId = 1,
                            OrderDateTime = new DateTime(2024, 12, 8, 3, 46, 36, 798, DateTimeKind.Local).AddTicks(7495),
                            OrderStatus = "Pending",
                            OrderTotal = 64.50m
                        },
                        new
                        {
                            Id = 2,
                            CustomerId = 2,
                            OrderDateTime = new DateTime(2024, 12, 8, 3, 46, 36, 798, DateTimeKind.Local).AddTicks(7512),
                            OrderStatus = "Pending",
                            OrderTotal = 55.70m
                        });
                });
            ...
            modelBuilder.Entity("BIGBACK.Domain.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PaymentDateTime = new DateTime(2024, 12, 8, 3, 46, 36, 798, DateTimeKind.Local).AddTicks(7629),
                        ...
                        new
                        {
                            ...
                            PaymentDateTime = new DateTime(2024, 12, 8, 3, 46, 36, 798, DateTimeKind.Local).AddTicks(7633),
